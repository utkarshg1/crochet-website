	...
	{:else}
		<div class="rounded-3xl bg-surface-card p-10 text-center shadow-ambient max-w-md">
			...
			<div class="mt-6 flex flex-col gap-3">
				<a href="/account" class="inline-block rounded-full bg-gradient-to-r from-primary to-primary-dim px-6 py-2.5 font-body text-sm font-semibold text-white shadow-ambient hover:brightness-110">
					Request a new link
				</a>
				<a href="/admin/login" class="inline-block rounded-full bg-surface-high px-6 py-2.5 font-body text-sm font-semibold text-on-surface hover:bg-surface-low">
					Admin sign-in
				</a>
			</div>
		</div>
